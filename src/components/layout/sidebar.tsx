...
export default function Sidebar({ role }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "flex flex-col h-full bg-white border-r border-gray-100 transition-all duration-200 flex-shrink-0",
        collapsed ? "w-16" : "w-60"
      )}
    >
      {/* Logo */}
      <div className="flex items-center h-16 px-4 border-b border-gray-100 flex-shrink-0">
        <div className="flex items-center gap-3 min-w-0">
          ...
          {!collapsed && (
            <span className="font-bold text-gray-900 truncate">inklabs</span>
          )}
        </div>
      </div>
